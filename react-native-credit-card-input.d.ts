declare module 'react-native-credit-card-input' {
  import { StyleProp, TextInputProps, Text, TextInput, View } from 'react-native';
  ...
  interface CreditCardInputProps extends LiteCreditCardInputProps {
    ...
    validatePostalCode?: (postCode: string) => 'incomplete' | 'valid' | 'invalid'; // Function to validate postalCode
